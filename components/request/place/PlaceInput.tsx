			...
			{isInputOpen && (
				<StyledPlaceCustomInput>
					<BasicInput
						...
						id="place"
						placeholder="장소이름"
						handleInputChange={(e) => handleChangeCustomPlace(e, "place")}
						handleInputDelete={(e) => handleDeleteCustomPlace(e, "place")}
					/>
					...
					<div className="address">
						<BasicInput
							...
							handleInputChange={(e) => handleChangeCustomPlace(e, "address1")}
							handleInputDelete={(e) => handleDeleteCustomPlace(e, "address1")}
						/>
						<BasicInput
							label=""
							hideLabel
							...
							handleInputChange={(e) => handleChangeCustomPlace(e, "address2")}
							handleInputDelete={(e) => handleDeleteCustomPlace(e, "address2")}
						/>
					</div>
				</StyledPlaceCustomInput>
			)}
