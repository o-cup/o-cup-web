...
import { EventType, PeopleType } from "../../../types";
...
const BiasEventList = ({ id, bias, events }: BiasEventListProps) => {
	...
	const [openedCategory, setOpenedCategory] = useState<("A" | "B" | "C" | "D" | "E")[]>([]);
	const [selectedCategory, setSelectedCategory] = useState<("A" | "B" | "C" | "D" | "E")[]>([]);
