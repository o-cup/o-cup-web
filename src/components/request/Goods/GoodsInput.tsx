  ...
  return (
    <StyledGoodsInput>
      ...
      {isDirectInputOpen ?
        ...
        : <GoodsSelectBox value={value} isSelectOpen={isSelectOpen} setSelectOpen={setSelectOpen}
                          handleSelectTitle={handleSelectTitle} handleSelectDirectInput={handleSelectDirectInput} />}
