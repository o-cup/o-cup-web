			...
			<StyledAdmin>
				<div className="adminContainer">
					...
					<label htmlFor="images">
						<h4>이벤트 포스터 이미지</h4>
						<span className="help">
							⚠️ 여러개 입력 가능, 한개 이상인 경우 &quot;, &quot;(쉼표 후 띄어쓰기)로 구분해주세요
						</span>
						<input
							type="text"
							id="images"
					...
					<label htmlFor="goods">
						...
						<div className="goodsContainer">
							...
							<button className="goodsSubmitBtn" type="button" onClick={handleSubmitGoods}>
								특전등록 ✓
							</button>
						</div>
					</label>
